     ...
     <section className="home-main-card">
       ...
       <div className="home-user-stats">
         ...
         <div className="home-stat">
           ...
           <span className="home-stat-data">
             {loading ? "--" : playerStats?.totalPoints ?? 0}
           </span>
         </div>
         <div className="home-stat">
           ...
           <span className="home-stat-data">
             {loading
               ? "--"
               : formatMinutes(studyStats?.weeklyStudyMinutes ?? 0)}
           </span>
         </div>
         <div className="home-stat">
           ...
           <span className="home-stat-data">
             {loading
               ? "--"
               : `${playerStats?.currentStreak ?? 0} days`}
           </span>
         </div>
         <div className="home-stat">
           ...
           <span className="home-stat-data">
             {loading
               ? "--"
               : `${playerStats?.longestStreak ?? 0} days`}
           </span>
         </div>
         <div className="home-stat">
           ...
           <span className="home-stat-data">
             {loading
               ? "--"
               : formatMinutes(studyStats?.totalStudyMinutes ?? 0)}
           </span>
         </div>
         <div className="home-stat">
         ...
         {loading ? (
           ...
           <div className="home-session-card">
             ...
             {activeSession.location && (
               <p>
                 Location:{" "}
                 {formatLocationLabel(activeSession.location)}
               </p>
             )}
           </div>
         ) : (
